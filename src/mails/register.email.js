      ...
      <div class="container">
        ...
        <div class="content">
          ...
          ${
            role === "admin"
              ? `
            <p>Thank you for registering as an admin with E-Commerce App. We are excited to have you on board. As an admin, you have full access to manage the platform.</p>
            <p>If you need assistance, reach out to us at <a href="mailto:thakursaad613@gmail.com">thakursaad613@gmail.com</a>.</p>
            `
              : `
            <p>Thank you for registering with E-Commerce App. To activate your account, please use the following activation code:</p>
